  ...
  methods: {
    ...
    onTabUpdate (config) {
      ...
      if (!this.tabsList.some(item => item.path === realPath)) {
        ...
        // determine whether there is a routing
